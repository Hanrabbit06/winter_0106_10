...
public class SimplNotepad extends JFrame implements ActionListener {
	...
	public void makeMenu() {
		...
		JMenu menuFile = new JMenu("File");//상위 메뉴
		JMenu menuFormat = new JMenu("Format");
		JMenu menuFont = new JMenu("Font");
		JMenu menuFontColor = new JMenu("FontColor");
		JMenu menuFontSize = new JMenu("FontSize");
		//JMenuItem : 상위메뉴 또는 하위 메뉴를 클릭했을 때 선택할 수 있는 항목
		itemNew = new JMenuItem("New");
		itemOpen = new JMenuItem("Open");
		itemSave = new JMenuItem("Save");
		itemExit = new JMenuItem("Exit");
		itemFont1 = new JMenuItem("굴림");
		itemFont2 = new JMenuItem("바탕");
		itemFont3 = new JMenuItem("궁서체");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(eItem==itemNew) {
			...
			area.setFont(new Font("바탕",Font.PLAIN,area.getFont().getSize()));
		}
